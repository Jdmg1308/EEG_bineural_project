...
public:
     ...
     * values().
     * \if ANDROID_ONLY
     * \param channelNum the optics channel to retrieve. (ie. \link com.choosemuse.libmuse.Optics.NIR730_LO\endlink)
     * \elseif IOS_ONLY
     * \param channelNum the ::IXNOptics channel to retrieve (ie. \link IXNOptics IXNOpticsNIR730LO\endlink)
     * \elseif WINDOWS_ONLY
     * \param channel_num the
     * \link ::interaxon::bridge::Optics OPTICS\endlink
     * channel to retrieve (ie. Optics::NIR730_LO)
     * \else
     * MISSING_DOCUMENTATION
     * \endif
     * \return the value requested.
