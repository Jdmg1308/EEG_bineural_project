...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel
{
    ...
    struct __declspec(empty_bases) FullTrustProcessLaunchResult : winrt::Windows::ApplicationModel::IFullTrustProcessLaunchResult
    {
        ...
        FullTrustProcessLaunchResult(FullTrustProcessLaunchResult const&) noexcept = default;
        FullTrustProcessLaunchResult(FullTrustProcessLaunchResult&&) noexcept = default;
        FullTrustProcessLaunchResult& operator=(FullTrustProcessLaunchResult const&) & noexcept = default;
        FullTrustProcessLaunchResult& operator=(FullTrustProcessLaunchResult&&) & noexcept = default;
    };
