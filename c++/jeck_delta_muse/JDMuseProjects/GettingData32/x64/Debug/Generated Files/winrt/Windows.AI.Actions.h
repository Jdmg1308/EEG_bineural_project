...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::TableActionEntity) consume_Windows_AI_Actions_IActionEntityFactory3<D>::CreateTableEntity(array_view<hstring const> data, uint32_t columnCount) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ContactActionEntity) consume_Windows_AI_Actions_IActionEntityFactory3<D>::CreateContactEntity(winrt::Windows::ApplicationModel::Contacts::Contact const& contact) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_AI_Actions_IActionInvocationContext<D>::ActionName() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_AI_Actions_IActionInvocationContext<D>::InvokerPackageFamilyName() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationContext) consume_Windows_AI_Actions_IActionRuntime2<D>::CreateInvocationContextWithWindowId(param::hstring const& actionId, winrt::Windows::UI::WindowId const& invokerWindowId) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntity) consume_Windows_AI_Actions_IActionRuntime2<D>::GetActionEntityById(param::hstring const& entityId) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(uint32_t) consume_Windows_AI_Actions_IActionRuntime2<D>::LatestSupportedSchemaVersion() const
    {
        uint32_t value{};
