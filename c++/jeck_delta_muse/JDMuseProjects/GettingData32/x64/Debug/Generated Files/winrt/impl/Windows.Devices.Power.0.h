...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(double) Severity() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsLowUserExperienceImpact() const;
    };
    ...
    struct consume_Windows_Devices_Power_IPowerGridForecast
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::TimeSpan) BlockDuration() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::Power::PowerGridData>) Forecast() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Devices::Power::PowerGridForecast) GetForecast() const;
        WINRT_IMPL_AUTO(winrt::event_token) ForecastUpdated(winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) ForecastUpdated(winrt::event_token const& token) const noexcept;
    };
