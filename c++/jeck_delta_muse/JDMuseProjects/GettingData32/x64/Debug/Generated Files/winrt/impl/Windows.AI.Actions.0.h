...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntityKind) Kind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntityDisplayInfo) DisplayInfo() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::FileActionEntity) CreateFileEntity(param::hstring const& path) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::DocumentActionEntity) CreateDocumentEntity(param::hstring const& path) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::PhotoActionEntity) CreatePhotoEntity(param::hstring const& path) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::TextActionEntity) CreateTextEntity(param::hstring const& text) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::RemoteFileActionEntity) CreateRemoteFileEntity(param::hstring const& sourceId, winrt::Windows::AI::Actions::RemoteFileKind const& fileKind, winrt::Windows::Foundation::Uri const& sourceUri, param::hstring const& fileId, param::hstring const& contentType, param::hstring const& driveId, param::hstring const& accountId, param::hstring const& extension) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::TextActionEntity) CreateTextEntity(param::hstring const& text, winrt::Windows::AI::Actions::ActionEntityTextFormat const& textFormat) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::StreamingTextActionEntityWriter) CreateStreamingTextActionEntityWriter(winrt::Windows::AI::Actions::ActionEntityTextFormat const& textFormat) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::TableActionEntity) CreateTableEntity(array_view<hstring const> data, uint32_t columnCount) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ContactActionEntity) CreateContactEntity(winrt::Windows::ApplicationModel::Contacts::Contact const& contact) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionFeedbackKind) FeedbackKind() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ActionName() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntityFactory) EntityFactory() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) InvokerPackageFamilyName() const;
        WINRT_IMPL_AUTO(void) SetInputEntity(param::hstring const& inputName, winrt::Windows::AI::Actions::ActionEntity const& inputValue) const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::NamedActionEntity>) GetInputEntities() const;
        WINRT_IMPL_AUTO(void) SetOutputEntity(param::hstring const& outputName, winrt::Windows::AI::Actions::ActionEntity const& outputValue) const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::NamedActionEntity>) GetOutputEntities() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationResult) Result() const;
        WINRT_IMPL_AUTO(void) Result(winrt::Windows::AI::Actions::ActionInvocationResult const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::hresult) ExtendedError() const;
        WINRT_IMPL_AUTO(void) ExtendedError(winrt::hresult const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::WindowId) InvokerWindowId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationHelpDetails) HelpDetails() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ActionId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) InvokerAppUserModelId() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationHelpKind) Kind() const;
        WINRT_IMPL_AUTO(void) Kind(winrt::Windows::AI::Actions::ActionInvocationHelpKind const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Title() const;
        ...
        WINRT_IMPL_AUTO(void) HelpUri(winrt::Windows::Foundation::Uri const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) HelpUriDescription() const;
        WINRT_IMPL_AUTO(void) HelpUriDescription(param::hstring const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::Hosting::ActionCatalog) ActionCatalog() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntityFactory) EntityFactory() const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationContext) CreateInvocationContext(param::hstring const& actionId) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionInvocationContext) CreateInvocationContextWithWindowId(param::hstring const& actionId, winrt::Windows::UI::WindowId const& invokerWindowId) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionFeedback) CreateActionFeedback(winrt::Windows::AI::Actions::ActionFeedbackKind const& feedbackKind) const;
        WINRT_IMPL_AUTO(void) SetActionAvailability(param::hstring const& actionId, bool isAvailable) const;
        WINRT_IMPL_AUTO(bool) GetActionAvailability(param::hstring const& actionId) const;
        WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntity) GetActionEntityById(param::hstring const& entityId) const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) LatestSupportedSchemaVersion() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FullPath() const;
    };
    ...
    struct consume_Windows_AI_Actions_INamedActionEntity
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntity) Entity() const;
        WINRT_IMPL_AUTO(void) Entity(winrt::Windows::AI::Actions::ActionEntity const& value) const;
    };
    ...
    struct consume_Windows_AI_Actions_IRemoteFileActionEntity
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::RemoteFileKind) FileKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Uri) SourceUri() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FileId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ContentType() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DriveId() const;
    ...
    struct consume_Windows_AI_Actions_IStreamingTextActionEntity
    {
        ...
        WINRT_IMPL_AUTO(hstring) GetText() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntityTextFormat) TextFormat() const;
        WINRT_IMPL_AUTO(winrt::event_token) TextChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::AI::Actions::StreamingTextActionEntity, winrt::Windows::AI::Actions::StreamingTextActionEntityTextChangedArgs> const& handler) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::StreamingTextActionEntity) ReaderEntity() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::ActionEntityTextFormat) TextFormat() const;
        WINRT_IMPL_AUTO(void) SetText(param::hstring const& text) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(com_array<hstring>) GetTextContent() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) RowCount() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) ColumnCount() const;
    };
