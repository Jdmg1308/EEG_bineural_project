...
WINRT_EXPORT namespace winrt::Windows::Gaming::Input::Preview
{
    ...
    struct __declspec(empty_bases) LegacyGipGameControllerProvider : winrt::Windows::Gaming::Input::Preview::ILegacyGipGameControllerProvider
    {
        ...
        LegacyGipGameControllerProvider(LegacyGipGameControllerProvider const&) noexcept = default;
        LegacyGipGameControllerProvider(LegacyGipGameControllerProvider&&) noexcept = default;
        LegacyGipGameControllerProvider& operator=(LegacyGipGameControllerProvider const&) & noexcept = default;
        LegacyGipGameControllerProvider& operator=(LegacyGipGameControllerProvider&&) & noexcept = default;
