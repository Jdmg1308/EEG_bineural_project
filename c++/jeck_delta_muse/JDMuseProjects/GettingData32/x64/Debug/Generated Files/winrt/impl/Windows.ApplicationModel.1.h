...
WINRT_EXPORT namespace winrt::Windows::ApplicationModel
{
        ...
        impl::consume_t<IFullTrustProcessLaunchResult>
    {
        ...
        IFullTrustProcessLaunchResult(IFullTrustProcessLaunchResult const&) noexcept = default;
        IFullTrustProcessLaunchResult(IFullTrustProcessLaunchResult&&) noexcept = default;
        IFullTrustProcessLaunchResult& operator=(IFullTrustProcessLaunchResult const&) & noexcept = default;
        IFullTrustProcessLaunchResult& operator=(IFullTrustProcessLaunchResult&&) & noexcept = default;
    };
        ...
        impl::consume_t<IFullTrustProcessLauncherStatics2>
    {
        ...
        IFullTrustProcessLauncherStatics2(IFullTrustProcessLauncherStatics2 const&) noexcept = default;
        IFullTrustProcessLauncherStatics2(IFullTrustProcessLauncherStatics2&&) noexcept = default;
        IFullTrustProcessLauncherStatics2& operator=(IFullTrustProcessLauncherStatics2 const&) & noexcept = default;
        IFullTrustProcessLauncherStatics2& operator=(IFullTrustProcessLauncherStatics2&&) & noexcept = default;
    };
