...
namespace winrt::impl
{
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Core::ICoreWindowDialog)->remove_Showing(impl::bind_in(cookie)));
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Core::ICoreWindowFlyout)->remove_Showing(impl::bind_in(cookie)));
    }
