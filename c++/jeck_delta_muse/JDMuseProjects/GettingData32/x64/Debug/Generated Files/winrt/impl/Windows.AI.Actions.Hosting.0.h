...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionDefinition>) GetAllActions() const;
        WINRT_IMPL_AUTO(winrt::event_token) Changed(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::AI::Actions::Hosting::ActionCatalog, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    struct consume_Windows_AI_Actions_Hosting_IActionDefinition
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) IconFullPath() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PackageFamilyName() const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionEntityRegistrationInfo>) GetInputs() const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionEntityRegistrationInfo>) GetOutputs() const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionOverload>) GetOverloads() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) DisplaysUI() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::AI::Actions::Hosting::ActionDisclaimerKind) DisclaimerKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) SchemaVersion() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PackageRelativeApplicationId() const;
    };
    ...
    struct consume_Windows_AI_Actions_Hosting_IActionEntityRegistrationInfo
    {
        ...
        WINRT_IMPL_AUTO(void) Kind(winrt::Windows::AI::Actions::ActionEntityKind const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DescriptionTemplate() const;
        WINRT_IMPL_AUTO(com_array<winrt::Windows::AI::Actions::Hosting::ActionEntityRegistrationInfo>) GetInputs() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) InvokeAsync(winrt::Windows::AI::Actions::ActionInvocationContext const& context) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) InvokeFeedbackAsync(winrt::Windows::AI::Actions::ActionInvocationContext const& context, winrt::Windows::AI::Actions::ActionFeedback const& feedback) const;
        WINRT_IMPL_AUTO(bool) GetSupportsFeedback() const;
    };
